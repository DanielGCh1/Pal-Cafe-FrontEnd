...
export default function EditRecipe() {
    ...
    const { admProduct, editAdmProduct, getAdmProduct, addIngredientList } = useAdmProduct();
    ...
    return <>
        <VStack h='100vh' alignItems='center'>
            ...
            <Box p='6' display="flex" justifyContent={'center'}>
                <Heading color="white" fontWeight="bold" size='2xl'>Agregar Ingredientes</Heading>
            </Box>
